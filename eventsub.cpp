...
{
	messageTypes.emplace(MESSAGE_TYPE_WELCOME,MessageType::WELCOME);
	messageTypes.emplace(MESSAGE_TYPE_NOTIFICATION,MessageType::NOTIFICATION);
	messageTypes.emplace(MESSAGE_TYPE_KEEPALIVE,MessageType::KEEPALIVE);

	subscriptionTypes.emplace(SUBSCRIPTION_TYPE_FOLLOW.name,SUBSCRIPTION_TYPE_FOLLOW);
	subscriptionTypes.emplace(SUBSCRIPTION_TYPE_REDEMPTION.name,SUBSCRIPTION_TYPE_REDEMPTION);
	subscriptionTypes.emplace(SUBSCRIPTION_TYPE_CHEER.name,SUBSCRIPTION_TYPE_CHEER);
	subscriptionTypes.emplace(SUBSCRIPTION_TYPE_RAID.name,SUBSCRIPTION_TYPE_RAID);
	subscriptionTypes.emplace(SUBSCRIPTION_TYPE_SUBSCRIPTION.name,SUBSCRIPTION_TYPE_SUBSCRIPTION);
	subscriptionTypes.emplace(SUBSCRIPTION_TYPE_RESUBSCRIPTION.name,SUBSCRIPTION_TYPE_RESUBSCRIPTION);
	subscriptionTypes.emplace(SUBSCRIPTION_TYPE_HYPE_TRAIN_START.name,SUBSCRIPTION_TYPE_HYPE_TRAIN_START);
	subscriptionTypes.emplace(SUBSCRIPTION_TYPE_HYPE_TRAIN_PROGRESS.name,SUBSCRIPTION_TYPE_HYPE_TRAIN_PROGRESS);
	subscriptionTypes.emplace(SUBSCRIPTION_TYPE_HYPE_TRAIN_END.name,SUBSCRIPTION_TYPE_HYPE_TRAIN_END);
